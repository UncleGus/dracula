...
namespace FuryOfDracula.GameLogic
{
    ...
    public class GameState
    {
        ...
        private List<EncounterTile> CreateEncounterPool()
        {
            ...
            tempEncounterDeck.Add(new EncounterTile(Encounter.Fog));
            tempEncounterDeck.Add(new EncounterTile(Encounter.Fog));
            tempEncounterDeck.Add(new EncounterTile(Encounter.MinionWithKnife));
            tempEncounterDeck.Add(new EncounterTile(Encounter.MinionWithKnife));
            tempEncounterDeck.Add(new EncounterTile(Encounter.MinionWithKnife));
            tempEncounterDeck.Add(new EncounterTile(Encounter.MinionWithKnifeAndPistol));
            tempEncounterDeck.Add(new EncounterTile(Encounter.MinionWithKnifeAndPistol));
            tempEncounterDeck.Add(new EncounterTile(Encounter.MinionWithKnifeAndRifle));
            tempEncounterDeck.Add(new EncounterTile(Encounter.MinionWithKnifeAndRifle));
            ...
            tempEncounterDeck.Add(new EncounterTile(Encounter.Thief));
            tempEncounterDeck.Add(new EncounterTile(Encounter.NewVampire));
            tempEncounterDeck.Add(new EncounterTile(Encounter.NewVampire));
            tempEncounterDeck.Add(new EncounterTile(Encounter.NewVampire));
            tempEncounterDeck.Add(new EncounterTile(Encounter.NewVampire));
            tempEncounterDeck.Add(new EncounterTile(Encounter.NewVampire));
