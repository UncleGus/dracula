...
namespace ConsoleHandler
{
    public class GameState
    {
        ...
        public GameState()
        {
            ...
            eventDeck.Add(new Event("Rufus Smith", false));
            eventDeck.Add(new Event("Jonathan Harker", false));
            eventDeck.Add(new Event("Sister Agatha", false));
            eventDeck.Add(new Event("Heroic Leap", false));
            eventDeck.Add(new Event("Great Strength", false));
            eventDeck.Add(new Event("Money Trail", false));
            eventDeck.Add(new Event("Sense of Emergency", false));
            eventDeck.Add(new Event("Sense of Emergency", false));
            eventDeck.Add(new Event("Vampiric Lair", false));
            eventDeck.Add(new Event("Long Day", false));
            eventDeck.Add(new Event("Long Day", false));
            eventDeck.Add(new Event("Mystic Research", false));
            eventDeck.Add(new Event("Mystic Research", false));
            eventDeck.Add(new Event("Advance Planning", false));
            eventDeck.Add(new Event("Advance Planning", false));
            eventDeck.Add(new Event("Advance Planning", false));
            eventDeck.Add(new Event("Newspaper Reports", false));
            eventDeck.Add(new Event("Newspaper Reports", false));
            eventDeck.Add(new Event("Newspaper Reports", false));
            eventDeck.Add(new Event("Newspaper Reports", false));
            eventDeck.Add(new Event("Newspaper Reports", false));
            eventDeck.Add(new Event("Re-Equip", false));
            eventDeck.Add(new Event("Re-Equip", false));
            eventDeck.Add(new Event("Re-Equip", false));
            eventDeck.Add(new Event("Consecrated Ground", false));
            eventDeck.Add(new Event("Telegraph Ahead", false));
            eventDeck.Add(new Event("Telegraph Ahead", false));
            eventDeck.Add(new Event("Hypnosis", false));
            eventDeck.Add(new Event("Hypnosis", false));
            eventDeck.Add(new Event("Stormy Seas", false));
            eventDeck.Add(new Event("Surprising Return", false));
            eventDeck.Add(new Event("Surprising Return", false));
            eventDeck.Add(new Event("Good Luck", false));
            eventDeck.Add(new Event("Good Luck", false));
            eventDeck.Add(new Event("Blood Transfusion", false));
            eventDeck.Add(new Event("Secret Weapon", false));
            eventDeck.Add(new Event("Secret Weapon", false));
            eventDeck.Add(new Event("Forewarned", false));
            eventDeck.Add(new Event("Forewarned", false));
            eventDeck.Add(new Event("Forewarned", false));
            eventDeck.Add(new Event("Chartered Carriage", false));
            eventDeck.Add(new Event("Chartered Carriage", false));
            eventDeck.Add(new Event("Chartered Carriage", false));
            eventDeck.Add(new Event("Excellent Weather", false));
            eventDeck.Add(new Event("Excellent Weather", false));
            eventDeck.Add(new Event("Escape Route", false));
            eventDeck.Add(new Event("Escape Route", false));
            eventDeck.Add(new Event("Hired Scouts", false));
            eventDeck.Add(new Event("Hired Scouts", false));
            eventDeck.Add(new Event("Hired Scouts", false));
            eventDeck.Add(new Event("Dracula's Brides", true));
            eventDeck.Add(new Event("Immanuel Hildesheim", true));
            eventDeck.Add(new Event("Quincey P. Morris", true));
            eventDeck.Add(new Event("Roadblock", true));
            eventDeck.Add(new Event("Unearthly Swiftness", true));
            eventDeck.Add(new Event("Time Runs Short", true));
            eventDeck.Add(new Event("Customs Search", true));
            eventDeck.Add(new Event("Devilish Power", true));
            eventDeck.Add(new Event("Devilish Power", true));
            eventDeck.Add(new Event("Vampiric Influence", true));
            eventDeck.Add(new Event("Vampiric Influence", true));
            eventDeck.Add(new Event("Night Visit", true));
            eventDeck.Add(new Event("Evasion", true));
            eventDeck.Add(new Event("Wild Horses", true));
            eventDeck.Add(new Event("False Tip-off", true));
            eventDeck.Add(new Event("False Tip-off", true));
            eventDeck.Add(new Event("Sensationalist Press", true));
            eventDeck.Add(new Event("Rage", true));
            eventDeck.Add(new Event("Seduction", true));
            eventDeck.Add(new Event("Control Storms", true));
            eventDeck.Add(new Event("Relentless Minion", true));
            eventDeck.Add(new Event("Relentless Minion", true));
            eventDeck.Add(new Event("Trap", true));
            eventDeck.Add(new Event("Trap", true));
            eventDeck.Add(new Event("Trap", true));
